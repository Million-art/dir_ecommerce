    ...
    <div className="border p-4 rounded shadow-2xl w-full max-w-[500px] transition duration-300 ease-in-out transform hover:scale-105">
      ...
      >
        <div>
          ...
          <button className="bg-purple-700 hover:bg-purple-800 text-white py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105">
            Add To Cart
          </button>
        </div>
      </div>
